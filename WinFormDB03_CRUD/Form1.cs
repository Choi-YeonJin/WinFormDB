...
namespace WinFormDB03_CRUD
{
    public partial class Form1 : Form
    {
        ...
        {
            conn = new MySqlConnection("server = localhost;port=3306;database=world;uid=root;pwd=0000");
            ...
            try
            {
                ...
                {
                    lableConnectionStates.Text = "DB 연결 성공";
                    lableConnectionStates.ForeColor = Color.Green;
                }
            }
            catch (Exception ex)
            {
