...
{  
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string connStr = "server=localhost;port=3306;database=mydb;uid=root;pwd=0000";
        ...
        private void OrdersTableRow_Click()
        {
            ...
            textBox13.Text = dataGridView1.Rows[selectedRowIndex].Cells[4].Value.ToString();
        }
        ...
        private void OrdersTableUpdate_Click()
        {
            ...
            dataAdapter.UpdateCommand.Parameters.AddWithValue("@orderdate", textBox13.Text);
